import { FiAward, FiCpu, FiTrendingUp, FiVolume2 } from "react-icons/fi";

export const newsArticles = [
  {
    id: 1,
    title: "Physiohub Awarded JCI Gold Seal of Approval",
    date: "June 05, 2026",
    category: "Accreditation",
    badge: "Gold Award",
    summary: "Joint Commission International (JCI) has awarded Physiohub the gold seal of approval for patient safety and rehabilitation excellence, recognizing our clinic-wide dedication to global healthcare quality.",
    content: "Physiohub has officially been accredited by the Joint Commission International (JCI), the world's premier body for healthcare quality evaluation. This prestigious gold seal recognizes our commitment to meeting the highest global safety standards, infection control protocols, and rehabilitation outcome metrics. The accreditation audit analyzed over 300 standards across patient rights, medication management, and clinical training. Our CEO stated: 'This is a testament to our relentless pursuit of safety, compassion, and innovation.'",
  ...
  },
  {
    ...
    badge: "Expansion",
    summary: "Physiohub has completed the second phase of its DHA facility expansion, featuring six state-of-the-art rehabilitation units and an advanced pediatric physiotherapy wing.",
  ...
  },
  {
    ...
    content: "Under our CSR umbrella, Physiohub mobilized four emergency physical therapy fleets to establish temporary diagnostic and rehabilitation hubs in underserved rural districts. Over 10,000 patients received comprehensive physiological checks, physical therapy sessions, pediatric reviews, and complimentary care packages. Over 150 complex orthopedic and neurological referrals were sponsored directly by our clinic, helping families access critical treatments free of charge.",
