...
const servicesData = [
  {
    ...
    tagColor: "#0284c7",
    tagBg: "#e0f2fe",
    overview: "Specialized movement rehabilitation for joints, muscles, and nerves to restore mobility and function.",
    symptoms: ["Chronic joint stiffness", "Post-surgical weakness", "Arthritis limitations", "Postural imbalances"],
    benefits: ["Skilled physical therapists", "Range of motion restoration", "Evidence-based therapy protocols", "Custom home exercises"],
    procedure: "Physical assessment → Mobility profiling → Progressive therapeutic exercise → Rehabilitation guidance.",
    tags: ["Manual Therapy", "Joint Mobilization", "Rehab Exercises", "Posture Care"],
  },
  {
    id: 2,
    ...
    tagColor: "#7c3aed",
    tagBg: "#ede9fe",
    overview: "Advanced spinal manipulation and joint decompression techniques to correct alignment and relieve nerve compression.",
    symptoms: ["Spine misalignment", "Chronic low back pain", "Sciatica & nerve pain", "Neck pain & stiffness"],
    benefits: ["Classified chiropractors", "Painless bone adjustments", "Immediate pressure relief", "Long-term postural improvement"],
    procedure: "Spine alignment analysis → Chiropractic adjustments → Decompression therapy → Ergonomic coaching.",
    tags: ["Spine Alignment", "Joint Manipulation", "Sciatica Relief", "Decompression"],
  },
  {
    id: 3,
    ...
    tagColor: "#0d9488",
    tagBg: "#ccfbf1",
    overview: "Dry and massage cupping to stimulate local blood flow, relieve deep muscle tension, and speed up recovery.",
    symptoms: ["Muscle soreness", "Poor blood circulation", "Deep myofascial tension", "Chronic muscle fatigue"],
    benefits: ["Increased blood flow", "Deep tissue relaxation", "Faster athletic recovery", "Reduced inflammation"],
    procedure: "Area sterilization → Cup placement & suction → Deep tissue circulation → Myofascial release.",
    tags: ["Dry Cupping", "Massage Cupping", "Myofascial Release", "Detoxification"],
  },
  {
    id: 4,
    ...
    tagColor: "#4f46e5",
    tagBg: "#e0e7ff",
    overview: "Traditional wet cupping therapy for detoxification, blood purification, and immune system stimulation.",
    symptoms: ["Systemic toxicity", "Chronic fatigue syndrome", "Inflammatory conditions", "Persistent muscle aches"],
    benefits: ["Blood detoxification", "Immune system boost", "Chronic pain mitigation", "Stress & tension relief"],
    procedure: "Suction placement → Superficial micro-scratches → Targeted toxic blood extraction → Antiseptic dressing.",
    tags: ["Wet Cupping", "Hijama", "Detox Therapy", "Pain Management"],
  },
  {
    id: 5,
    ...
    tagColor: "#dc2626",
    tagBg: "#fee2e2",
    overview: "Modern electronic modalities like TENS, EMS, and ultrasound to block pain signals and accelerate muscle healing.",
    symptoms: ["Acute pain & inflammation", "Muscle atrophy", "Post-op swelling", "Persistent muscle spasms"],
    benefits: ["Non-invasive pain block", "Accelerated tissue repair", "Improved local blood flow", "Restoration of muscle tone"],
    procedure: "Modality selection (TENS/EMS) → Electrode placement → Controlled electro-stimulation → Recovery check.",
    tags: ["TENS therapy", "Muscle Stimulation", "Ultrasound Therapy", "Swelling Care"],
  },
  {
    id: 6,
    title: "Dry Needling",
    icon: LuActivity,
    bgImage: "https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&w=800&q=80",
    accentColor: "#059669",
    lightBg: "#ecfdf5",
    borderColor: "#a7f3d0",
    tagColor: "#059669",
    tagBg: "#d1fae5",
    overview: "Inserting fine needles into trigger points to release deep muscle spasms and relieve chronic pain.",
    symptoms: ["Myofascial trigger points", "Muscle knots & spasms", "Radiating referred pain", "Chronic joint overload"],
    benefits: ["Release of deep knots", "Immediate pain mitigation", "Increased joint range of motion", "Neuromuscular regulation"],
    procedure: "Trigger point identification → Fine needle insertion → Intramuscular spasm release → Muscle recovery stretching.",
    tags: ["Trigger Point", "Intramuscular Stimulation", "Myofascial Release", "Spasm Relief"],
  },
];
