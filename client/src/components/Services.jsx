...
const servicesData = [
  {
    ...
    title: "Orthopedic PT",
    icon: LuBone,
    bgImage: "https://images.unsplash.com/photo-1597764690523-15bea4c581c9?auto=format&fit=crop&w=800&q=80",
    accentColor: "#0284c7",
    lightBg: "#f0f9ff",
    borderColor: "#bae6fd",
    tagColor: "#0284c7",
    tagBg: "#e0f2fe",
    overview: "Specialized rehabilitation for joint, bone, and spine disorders, facilitating safe recovery from orthopedic surgeries.",
    symptoms: ["Post-surgical recovery", "Chronic joint stiffness", "Fracture rehabilitation", "Back & spine pain"],
    benefits: ["OCS certified therapists", "Range of motion recovery", "Advanced pain modalities", "Custom home protocols"],
    procedure: "Orthopedic assessment → Joint range profiling → Progressive exercise regimen → Mobilization techniques → Return to daily function.",
    tags: ["Joint Replacement", "Spine Care", "Manual Therapy", "Fracture Recovery"],
  },
  {
    id: 2,
    title: "Musculoskeletal PT",
    icon: LuActivity,
    ...
    tagColor: "#7c3aed",
    tagBg: "#ede9fe",
    overview: "Comprehensive management of soft tissue injuries, muscle spasms, chronic joint pains, and posture dysfunction.",
    symptoms: ["Muscle strains & spasms", "Ligament & tendon sprains", "Chronic neck & back pain", "Postural imbalances"],
    benefits: ["Drug-free pain relief", "Targeted neuromuscular therapy", "Posture & ergonomics guidance", "Prevention of pain recurrence"],
    procedure: "Musculoskeletal profiling → Soft tissue mobilization → Stabilization exercises → Corrective alignment training.",
    tags: ["Myofascial Release", "Dry Needling", "Core Stability", "Chronic Pain Care"],
  },
  {
    id: 3,
    title: "Sports PT",
    icon: LuActivity,
    bgImage: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=800&q=80",
    accentColor: "#0d9488",
    lightBg: "#f0fdfa",
    borderColor: "#99f6e4",
    tagColor: "#0d9488",
    tagBg: "#ccfbf1",
    overview: "High-performance rehabilitation and sports conditioning, returning athletes to play quickly and preventing reinjury.",
    symptoms: ["ACL / ligament tears", "Rotator cuff injuries", "Shin splints", "Tennis & golfer's elbow"],
    benefits: ["Sports-specific movement analysis", "Conditioning & plyometric work", "Safe return-to-play testing", "Advanced athletic taping"],
    procedure: "Athletic motion analysis → Strength & speed testing → Targeted athletic rehab → Functional play simulation.",
    tags: ["ACL Rehabilitation", "Movement Screening", "Athletic Conditioning", "Injury Prevention"],
  },
  {
    id: 4,
    title: "Neurological PT",
    icon: GiBrain,
    bgImage: "https://images.unsplash.com/photo-1559757175-5700dde675bc?auto=format&fit=crop&w=800&q=80",
    accentColor: "#4f46e5",
    lightBg: "#e0e7ff",
    borderColor: "#c7d2fe",
    tagColor: "#4f46e5",
    tagBg: "#e0e7ff",
    overview: "Neurorehabilitation promoting neuroplasticity for patients recovering from stroke, Parkinson's, and balance disorders.",
    symptoms: ["Post-stroke weakness", "Balance & gait instability", "Parkinson's tremors & stiffness", "MS mobility limitations"],
    benefits: ["Neuroplastic pathway stimulation", "Fall-prevention training", "Adaptive equipment guidance", "Enhanced motor control"],
    procedure: "Neurological function testing → Gait & balance evaluation → Path retraining exercises → Repetitive task training.",
    tags: ["Stroke Rehab", "Vestibular Therapy", "Gait Training", "Motor Retraining"],
  },
  {
    id: 5,
    title: "Cardiopulmonary PT",
    icon: GiHeartBeats,
    bgImage: "https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?auto=format&fit=crop&w=800&q=80",
    accentColor: "#dc2626",
    lightBg: "#fef2f2",
    borderColor: "#fecaca",
    tagColor: "#dc2626",
    tagBg: "#fee2e2",
    overview: "Endurance-focused cardiovascular and pulmonary conditioning to improve lung capacity and cardiac stamina.",
    symptoms: ["Shortness of breath on exertion", "Post-heart attack recovery", "COPD breathing restriction", "Chronic respiratory fatigue"],
    benefits: ["Monitored aerobic exercises", "Breathing efficiency improvement", "Reduced fatigue & higher stamina", "Post-bypass mobilization"],
    procedure: "Cardiovascular endurance assessment → Risk profiling → Monitored aerobic conditioning → Chest expansion therapy.",
    tags: ["Cardiac Rehab", "COPD Recovery", "Breathing Retraining", "Endurance Training"],
  },
  {
    id: 6,
    title: "Pediatric PT",
    ...
    tagColor: "#059669",
    tagBg: "#d1fae5",
    overview: "Fun, play-based physical therapy designed to assist children in meeting developmental motor milestones.",
    symptoms: ["Delayed sitting or walking", "Cerebral Palsy mobility issues", "Torticollis neck stiffness", "Pediatric joint pains"],
    benefits: ["Playful clinical environment", "Milestone achievement tracking", "Early intervention assessment", "Family home guidance"],
    procedure: "Motor milestone check → Playful function screening → Fun range stretching → Strength building through play.",
    tags: ["Milestone Training", "Pediatric Stretching", "Balance Games", "Spasticity Care"],
  },
];
