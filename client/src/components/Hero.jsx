...
// ── ONLY CHANGE from your original: added onBookAppointment prop
// ── and wired the 2 buttons to it ────────────────────────────
...
// ── ADD onBookAppointment to props ────────────────────────────
        ...
        <div style={{
          ...
          >
            ...
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap", justifyContent: "center", marginTop: "8px" }}>
              ...
              {/* ── ONLINE CONSULTATION → opens modal (video type) */}
              <motion.button
                variants={fadeUpVariant}
                className="hbtn hbtn-glass"
                onClick={() => onBookAppointment && onBookAppointment()}
