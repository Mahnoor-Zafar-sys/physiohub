...
const navLinks = [
  ...
  { name: "Services",           page: "services" },   // ← clicks open ServicesPage
  {
    name: "Resources",
    isDropdown: true,
    align: "right",
  ...
  { name: "Contact Us",          page: "contact" },  // ← clicks open ContactUs page
];

// ── NAVBAR COMPONENT ──────────────────────────────────────────────────────────
// Props:
//   onNavigate(pageName) — called when user clicks a page-level link (e.g. "services")
//   Pass this down from App.jsx
