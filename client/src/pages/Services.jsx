...
//           8 specialties · 50+ procedures · Board-certified specialists delivering exceptional care with compassion and technology.
//         </motion.p>
...
//           {[{num:"8+",label:"Specialties"},{num:"50+",label:"Procedures"},{num:"30+",label:"Doctors"},{num:"10K+",label:"Patients Treated"}].map((s,i) => (
